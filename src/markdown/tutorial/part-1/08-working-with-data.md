...
This data follows the *[JSON:API](https://jsonapi.org/)* format, which is *slightly* different than the hard-coded data that we were returning from the model hook before.
